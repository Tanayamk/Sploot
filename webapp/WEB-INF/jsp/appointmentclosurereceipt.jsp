...
<body style='
  ...
  font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
	...
	<header>
            ...
            You are logged in as a Business Partner</br>
...
            <table border="0">
                <tr>
                        <td colspan="2" align="center"><h2>Appointment Closure Initiated Successfully for Appointment Id <c:out value="${appointmentid}"/> </h2></td>
            </tr>
            <tr>
                    <td>Expect Further Communication over email</td>
